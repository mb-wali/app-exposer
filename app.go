...
func NewExposerApp(init *ExposerAppInit, ingressClass string, cs kubernetes.Interface) *ExposerApp {
	...
	vice.POST("/launch", app.internal.LaunchApp)
	...
	vice.POST("/:id/download-input-files", app.internal.TriggerDownloads)
	vice.POST("/:id/save-output-files", app.internal.TriggerUploads)
	vice.POST("/:id/exit", app.internal.VICEExit)
	vice.POST("/:id/save-and-exit", app.internal.SaveAndExit)
	vice.GET("/:analysis-id/pods", app.internal.GetPods)
	vice.GET("/:analysis-id/logs", app.internal.GetLogs)
	vice.POST("/:analysis-id/time-limit", app.internal.TimeLimitUpdate)
	vice.GET("/:analysis-id/time-limit", app.internal.GetTimeLimit)
	vice.GET("/:host/url-ready", app.internal.URLReady)
	...
	viceadmin.POST("/:analysis-id/download-input-files", app.internal.AdminTriggerDownloads)
	viceadmin.POST("/:analysis-id/save-output-files", app.internal.AdminTriggerUploads)
	viceadmin.POST("/:analysis-id/exit", app.internal.AdminExit)
	viceadmin.POST("/:analysis-id/save-and-exit", app.internal.AdminSaveAndExit)
	viceadmin.GET("/:analysis-id/time-limit", app.internal.AdminGetTimeLimit)
	viceadmin.POST("/:analysis-id/time-limit", app.internal.AdminTimeLimitUpdate)
	viceadmin.GET("/:analysis-id/external-id", app.internal.AdminGetExternalID)
