...
func NewExposerApp(init *ExposerAppInit, ingressClass string, cs kubernetes.Interface) *ExposerApp {
	...
	app.router.HandleFunc("/vice/{analysis-id}/pods", app.VICEPods).Methods("GET").Queries("user", "")
	app.router.HandleFunc("/vice/{analysis-id}/pods/{pod}/logs", app.VICELogs).Methods("GET").Queries("user", "")
