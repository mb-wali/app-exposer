...
func main() {
	var (
		...
		viceDefaultBackendService     = flag.String("vice-default-backend", "nginx-ingress-controller-vice-default-backend", "The name of the service to use as the default backend for VICE ingresses")
